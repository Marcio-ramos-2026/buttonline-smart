...
export const PrintButton = ({
  ...
  const handlePrint = async () => {
    ...
    const originalCanvas = await canvas.clone(["cardenas_print", "cardenas_tags", "cardenas_canvas","cardenas_mark","pathType","cardenas_overlay","cardenas_children_wrapper"]);
